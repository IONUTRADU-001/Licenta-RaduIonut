...
interface IPhotosUploaderProps {
  addedPhotos: any[];
  onChange: (event: any) => void;
}

export default function PhotosUploader({ addedPhotos, onChange }: IPhotosUploaderProps) {
  ...
  function removePhoto(ev: any, filename: string) {
    ev.preventDefault();
    onChange([...addedPhotos.filter((photo: any) => photo !== filename)]);
  }

  function selectAsMainPhoto(ev: any, filename: string) {
    ev.preventDefault();
    onChange([filename, ...addedPhotos.filter((photo: any) => photo !== filename)]);
  }
